...
function PlanD() {
  return (
    <div className="flex flex-col lg:flex-row justify-center items-center pt-20 pb-20 gap-12 sm:gap-16 lg:gap-20 px-4 sm:px-8 h-auto">
      {/* Left Section */}
      ...
      {/* Right Section (Image) */}
      <div className="mt-10 lg:mt-0 flex justify-center lg:justify-end w-full lg:w-auto">
        <Image
          width={450}
          height={300}
          src="/ballcoin.jpg"
